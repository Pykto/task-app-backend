...
class TaskSchema(Schema):
    ...
    state = fields.Str(validate=validate.OneOf(['PENDING', 'IN_PROGRESS', 'COMPLETED', 'CANCELED']), missing='PENDING')
...
class TaskUpdateSchema(Schema):
    ...
    state = fields.Str(validate=validate.OneOf(['PENDING', 'IN_PROGRESS', 'COMPLETED', 'CANCELED']))
    expiration_date = fields.DateTime(allow_none=True)